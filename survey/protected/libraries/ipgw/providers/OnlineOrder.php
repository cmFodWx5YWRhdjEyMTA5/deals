<?php
/**
 * This file implements Online payment provider functionality
 *
 * Usage:
 * 
 ...
 *		'notify'		=> A::app()->getRequest()->getBaseUrl().'/paymentProviders/handlePayment/online_order',	// 
...
class OnlineOrder extends PaymentGateway
{
	/** @str */
	const NL = "\n";
