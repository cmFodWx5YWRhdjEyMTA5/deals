...
class Category extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('category_name, category_slug, sub_category_slug, parent_id', 'length', 'max'=>255),
			array('category_type', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('category_id, category_name, category_slug, sub_category_slug, parent_id, category_type', 'safe', 'on'=>'search'),
		);
	}
