...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('url_alias')); ?>:</b>
	<?php echo CHtml::encode($data->url_alias); ?>
	<br />
	...
	<?php echo CHtml::encode(Generic::getCategoriesName($data->categories)); ?>
	<br />
