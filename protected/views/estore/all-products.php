...
<div class="wrap">
    ...
    <div id="content">
        <div class="content-page">
            <div class="container">
                <h2 class="title-shop-page">All Products</h2>
                                ...
                                <div class="item-deal-product">
                                    <div class="product-thumb">
                                        ...
                                        <div class="product-info-cart">
                                            ...
                                            <a class="addcart-link" href="<?=$base_url.'/e-store/'.$store_details->url_alias?>/product-details/<?=$products['id']?>"><i class="fa fa-eye"></i> VIEW DETAILS</a>
                                        </div>
                                    </div>
                                    <div class="product-info">
                                        ...
                                        <div class="deal-shop-social">
                                            <a href="<?=$base_url.'/e-store/'.$store_details->url_alias?>/product-details/<?=$products['id']?>" class="deal-shop-link">view details</a>
