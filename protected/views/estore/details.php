                                ...
                                <ul class="list-product-related">
                                    ...
                                    <li class="clearfix">
                                        <div class="product-related-thumb">
                                            <a href="<?=$base_url.'/e-store/'.$store_details->url_alias?>/product-details/<?=$individual['id']?>"><img src="<?= ImageHelper::cloudinary($images[0],$related_image_opt)?>" alt="" /></a>
                                        </div>
                                        <div class="product-related-info">
                                            <h3 class="title-product"><a href="<?=$base_url.'/e-store/'.$store_details->url_alias?>/product-details/<?=$individual['id']?>"><?=$individual['title']?></a></h3>
