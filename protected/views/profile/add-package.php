                                ...
                                <fieldset>
                                    <div class="section postdetails">
                                        ...
                                        <div class="row form-group add-title" id='title' title="Keep it short but catchy and no pirce or phone number, Example: iPhone 6 Plus 64GB Black Unlocked">
                                            ...
                                            <div class="col-sm-9" >
                                                <input type="text" name="ads_title" id="ad_title_business" class="form-control"  placeholder="package name i.e Speed 10 Mbps">
                                            </div>
                                            <div id="message"></div>
                                        </div>
                                    ...
                                    <div class="checkbox section agreement">
                                        ...
                                        <button type="submit" id="ad_submit" class="btn btn-theme" style="width: 100%">Ad Your Package</button>
                                    </div><!-- section -->
