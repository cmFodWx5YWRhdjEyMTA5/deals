...
<input id="maximum" type="hidden" name="maximum" value="<?=$maximum_price[0]['max_price']?>">
<input id="minimum" type="hidden" name="minimum" value="<?=$minimum_price[0]['min_price']?>">
<!-- End Header -->
<div id="content">
				...
				<div class="col-md-9 col-sm-8 col-xs-12 main-content">
					<div class="main-content-shop">
						...
						<div class="list-shop-cat">
							<ul>
								<li><a href="#">Business <span class="business"></span></a></li>
								<li><a href="#">Individuals <span class="personal"></span></a></li>
								<li><a href="#">Promotional <span class="promotion"></span></a></li>
...
<script type="text/javascript">
	...
	function displayAllRecords(numRecords,pageNum,viewType) {
		...
		$.ajax({
			type: "GET",
			url: SITE_URL + "category/ListAllAdUsingAjax",
			data: {show:numRecords,pagenum:pageNum,view:viewType,maximum_price:maximum_price,minimum_price:minimum_price,condition:condition_value,is_featured:is_featured,is_premium:is_premium,is_top:is_top,is_hot:is_hot,locations:location_value},
			cache: false,
			dataType:"json",
			beforeSend: function() {
