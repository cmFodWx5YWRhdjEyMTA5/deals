                                ...
                                <div class="col-xs-12 col-md-6">
                                    <form action="javascript:void(0);" id="estore-update" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="facebook_link" name="facebook_link" value="<?=$store_details->facebook_link?>"  class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label>Twitter Link</label>
                                            <input type="text" id="twitter_link" name="twitter_link" value="<?=$store_details->twitter_link?>"  class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label>LinkedIn Link</label>
                                            <input type="text" id="linkedin_link" name="linkedin_link" value="<?=$store_details->linkedin_link?>"  class="form-control" >
                                        </div>
                                        <div class="form-group">
                                            <label>Google Plus Link</label>
                                            <input type="text" id="google_plus_link" name="google_plus_link" value="<?=$store_details->google_plus_link?>"  class="form-control" >
                                        </div>
                                        <div class="form-group">
