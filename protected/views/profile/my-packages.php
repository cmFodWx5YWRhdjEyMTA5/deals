        ...
        <div id="tab002" class="uzr-panel tab-panel">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-5 col-md-6">
                        <div class="icon-heading">
                            <h4><i class="adicon-heart tc7"></i> My Packages</h4>
                        </div>
                    </div>
            ...
            <div class="inner">
                ...
                <div class="call-to-action-2">
                    <div class="inner">
                        <p><strong>Post another package now!</strong></p>
                        ...
                        <div class="">
                            <div class="row">
                                <div class="col-sm-12 text-center">
                                    <h2 class="title">Do you want to post your internet package?</h2>
                                    <h4>Add your package on www.bdbroadbanddeals.com</h4>
                                    <a href="javascript:void(0);" onclick="CheckLogin()" class="btn btn-transparent" style="background-color:red">Click Here</a>
                                </div>
                            </div><!-- row -->
                        </div><!-- contaioner -->
            ...
            success : function(response){
                if(response.status=="success"){
                    if(response.ad_status == '1') {
                        //window.location = SITE_URL+'ad?ad_id='+encodeURIComponent(btoa(ad_id));
                        window.open(
