                        ...
                        <div class="inner" style="border: 1px solid green; border-radius: 10px">
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <form action="javascript:void(0);" id="isp-update" method="post">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#isp-update').on('submit',function(e){
        ...
        function updateEstore(){
            ...
            $.ajax({
                ...
                dataType:"json",
                beforeSend:function(){
                    $("#update_name_status").fadeOut();$("#isp_update_submit").html('<span class="glyphicon glyphicon-transfer"></span> &nbsp; Submitting ...');
                },
                success:function(response){
                    if(response.status=="success"){
                        $("#isp_update_submit").html('<img src="'+SITE_URL+'images/ajax-loader.gif" /> &nbsp; Submitting Data ...');
                        function redirect(){
