...
#These are not important for e-store with service
...
$product_details = $store_details->product_details;
$product_images = $store_details->product_images;
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-7 col-md-8">
                        <div class="icon-heading">
                            <h4><i class="adicon-create tc4"></i>Please Complete Your E-Store !</h4>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        ...
        function updateEstore(){
            ...
            $.ajax({
                ...
                dataType:"json",
                beforeSend:function(){
                    $("#update_name_status").fadeOut();$("#estore_update_submit").html('<span class="glyphicon glyphicon-transfer"></span> &nbsp; Submitting ...');
                },
