                                ...
                                <fieldset>
                                    <div class="section postdetails">
                                        ...
                                        <div class="row form-group add-title" id='title' title="Keep it short but catchy and no pirce or phone number, Example: iPhone 6 Plus 64GB Black Unlocked">
                                            ...
                                            <div class="col-sm-9" >
                                                <input type="text" name="job_title" id="job_title" class="form-control"  placeholder="Executive Manager" value="<?php echo $job_details->title; ?>">
                                            </div>
                                            <div id="message"></div>
                                        </div>
                                        ...
                                        <div class="row form-group add-vacancy" id='vacancy' title="">
                                            ...
                                            <div class="col-sm-9" >
                                                <input type="text" name="job_vacancy" id="job_vacancy" class="form-control"  placeholder="5" value="<?php echo $job_details->vacancy; ?>">
                                            </div>
                                            <div id="message"></div>
                                        </div>
                                        ...
                                        <div class="row form-group category" id='category' title="">
                                            ...
                                            <div class="col-sm-9" >
                                                <input type="text" name="job_category" id="job_category" class="form-control"  placeholder="Marketing" value="<?php echo $job_details->job_category; ?>">
                                            </div>
                                            <div id="message"></div>
                                        </div>
                                        ...
                                        <div class="row form-group job-description" id="description" title="">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="job_description" id="job_description" placeholder="" rows="8"><?php echo $job_details->description; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group education-requirement" id="edu_requirement" title="">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="educational_requirement" id="educational_requirement" placeholder="" rows="8"><?php echo $job_details->educational_req; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group exp_requirement" id="exp_requirement" title="">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="experience_requirement" id="experience_requirement" placeholder="" rows="8"><?php echo $job_details->experiment_req; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group salary" id='salary' title="">
                                            ...
                                            <div class="col-sm-9" >
                                                <input type="text" name="job_salary" id="job_salary" class="form-control"  placeholder="40000 BDT or Negotiable" value="<?php echo $job_details->salary; ?>">
                                            </div>
                                            <div id="message"></div>
                                        </div>
                                        ...
                                        <div class="row form-group deadline" id='deadline' title="">
                                            ...
                                            <div class="col-sm-9" >
                                                <input type="text" name="job_deadline" id="job_deadline" class="form-control"  placeholder="2018-12-01" value="<?php echo $job_details->deadline; ?>">
                                            </div>
                                            <div id="message"></div>
                                        </div>
                                        ...
                                        <div class="row form-group job-type" id='job-type' title="">
                                            ...
                                            <div class="col-sm-9" >
                                                <input type="text" name="job_type" id="job_type" class="form-control"  placeholder="Full Time" value="<?php echo $job_details->job_type; ?>">
                                            </div>
                                            <div id="message"></div>
                                        </div>
                                        ...
                                        <div class="row form-group job-location" id='job-location' title="">
                                            ...
                                            <div class="col-sm-9" >
                                                <input type="text" name="job_location" id="job_location" class="form-control"  placeholder="Dhaka etc." value="<?php echo $job_details->job_location; ?>">
                                            </div>
                                            <div id="message"></div>
                                        </div>
                                        ...
                                        <div class="row form-group job-requirement" id="job-requirement" title="">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="job_requirement" id="job_requirement" placeholder="" rows="8"><?php echo $job_details->job_req; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group additional_comment" id="additional_comment" title="">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="additional_requirement" id="additional_requirement" placeholder="" rows="8"><?php echo $job_details->additional; ?></textarea>
                                            </div>
                                        </div>
                                        <input type="hidden" name="user_id" id="user_id" value="<?php echo $profile_data['id']; ?>">
                                        <input type="hidden" name="job_id" id="job_id" value="<?php echo $job_details->id; ?>">   
