                            ...
                            <div class="footer-box6">
                                <div class="social-footer social-network">
                                    <ul>
                                        ...
                                        <li><a target="_blank" href="<?=Generic::getURLwithScheme($facebook_link)?>"><img alt="facebook" src="<?=$base_url?>/images/home1/s1.png"></a></li>
                                        <?php } ?>
                                        <?php if(!empty($store_details->twitter_link)) { ?>
                                        <li><a target="_blank" href="<?=Generic::getURLwithScheme($twitter_link)?>"><img alt="twitter" src="<?=$base_url?>/images/home1/s2.png"></a></li>
                                        <?php } ?>
                                        <?php if(!empty($store_details->linkedin_link)) { ?>
                                        <li><a target="_blank" href="<?=Generic::getURLwithScheme($linkedin_link)?>"><img alt="LinkedIn" src="<?=$base_url?>/images/home1/s3.png"></a></li>
                                        <?php } ?>
                                        <?php if(!empty($store_details->google_plus_link)) { ?>
                                        <li><a target="_blank" href="<?=Generic::getURLwithScheme($google_plus_link)?>"><img alt="Google Plus" src="<?=$base_url?>/images/home1/s4.png"></a></li>
                                    	<?php } ?>
