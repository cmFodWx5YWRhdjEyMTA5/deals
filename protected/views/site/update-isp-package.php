            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="section quick-rules">
                        <h4>Quick rules</h4>
                        <p class="lead" style="font-size: 16px">Posting package on <a href="#">bdbroadbanddeals.com</a> is free! However, all packages must follow our rules:</p>

                        <ul>
                            <li>Do not post the same package more than once</li>
