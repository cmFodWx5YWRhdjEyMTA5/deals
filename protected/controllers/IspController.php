...
class IspController extends Controller
{
	...
	public function actionContact($country_code = '',$company_name)
	{
		...
		if(isset($_POST['submit'])){
			...
			$subject = "You have received a message from your ISP Company at bdbroadbanddeals";
			$message_content = "<p>Mr/Mrs $name is in contact with you through your ISP company in bdbroadbanddeals.com. User information including his/her message is given below.
	...
	public function actionAllProducts($country_code = '',$company_name){
		...
		//Generic::_setTrace($all_products);
		$opt = array(
