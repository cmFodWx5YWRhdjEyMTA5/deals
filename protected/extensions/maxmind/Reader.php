...
require_once dirname(__FILE__) . "/Reader/Decoder.php";
require_once dirname(__FILE__) . "/Reader/InvalidDatabaseException.php";
require_once dirname(__FILE__) . "/Reader/Metadata.php";
require_once dirname(__FILE__) . "/Reader/Util.php";
